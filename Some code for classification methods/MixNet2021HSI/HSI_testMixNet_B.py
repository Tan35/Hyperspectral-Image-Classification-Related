...
if __name__ == '__main__':
    ...
    train_loader = torch.utils.data.DataLoader(dataset=trainset, batch_size=100, shuffle=True, num_workers=2)
    test_loader = torch.utils.data.DataLoader(dataset=testset, batch_size=100, shuffle=False, num_workers=2)
