...
mat_data = sio.loadmat('/home/amax/xibobo/SSRN-master/datasets/IN/Indian_pines_corrected.mat')
data_UP = mat_data['indian_pines_corrected']
mat_gt = sio.loadmat('/home/amax/xibobo/SSRN-master/datasets/IN/Indian_pines_gt.mat')
...
#    train_indices, test_indices = sampleFixNum.samplingDiffFixedNum([30, 150, 150, 100, 150, 150, 20, 150, 15, 150, 150, 150, 150, 150, 50, 50], gt)
    train_indices, test_indices = sampleFixNum.sampling(0.05, gt)
